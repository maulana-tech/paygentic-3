    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.337 2.88.9M12 20c-1.657 0-3-.895-3-2s1.343-2 3-2 3 .895 3 2-1.343 2-3 2m-2-4h.01M6 16H4v2h2v-2z"
        />
      </svg>
    ),
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={2}
              d="M12 8v4l3 3m6-3a4 4 0 11-8 0 4 4 0 018 0z"
            />
          </svg>
          <div>
            <h3 className="font-semibold text-text-main">Activity</h3>
            <p className="text-xs text-text-secondary">
              Recent agent actions, purchases, and system events
            </p>
          </div>
        </div>
        ...
        {filteredLogs.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm font-medium text-text-secondary">
              {filter === "ALL"
                ? "No activity yet"
                : `No ${filter.toLowerCase().replace("_", " ")} yet`}
            </p>
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3 px-4 py-3">
                    ...
                    {log.details && (
                      <div
                        className={`shrink-0 pt-1 text-text-secondary transition-transform ${isExpanded ? "rotate-180" : ""}`}
                      >
                        <svg
                          className="h-4 w-4"
                          fill="none"
